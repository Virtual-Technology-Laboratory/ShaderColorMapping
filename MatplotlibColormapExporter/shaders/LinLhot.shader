...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (0.02250, 0.01210, 0.01210, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.19270, 0.02250, 0.03110, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.32430, 0.01060, 0.00000, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.44630, 0.00000, 0.00910, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.57060, 0.00000, 0.07370, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.69690, 0.00000, 0.13370, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.82130, 0.00000, 0.17920, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.86360, 0.00000, 0.05650, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.88210, 0.25550, 0.00000, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.87200, 0.41820, 0.00000, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.84240, 0.55520, 0.00000, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (0.80310, 0.67760, 0.00000, 1.00000)
    _SegmentData012 ("Segment Color 012", Color) = (0.76590, 0.78700, 0.00000, 1.00000)
    _SegmentData013 ("Segment Color 013", Color) = (0.81700, 0.82960, 0.00000, 1.00000)
    _SegmentData014 ("Segment Color 014", Color) = (0.88530, 0.88960, 0.41130, 1.00000)
    _SegmentData015 ("Segment Color 015", Color) = (0.94810, 0.94860, 0.71650, 1.00000)

...
Properties {
    ...
    _SegmentData005 ("Segment Color 005", Color) = (0.96571, 0.96724, 0.96809, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.81961, 0.89804, 0.94118, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.56647, 0.76870, 0.86851, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.26275, 0.57647, 0.76471, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.12726, 0.39585, 0.66874, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.01961, 0.18824, 0.38039, 1.00000)

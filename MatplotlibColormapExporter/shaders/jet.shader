...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (0.00000, 0.00000, 0.50000, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.00000, 0.00000, 0.99911, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.00000, 0.00196, 1.00000, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.00000, 0.86471, 0.99620, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.00000, 0.89608, 0.97090, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.08539, 1.00000, 0.88235, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.93295, 1.00000, 0.03479, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.97090, 0.95933, 0.00000, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.99620, 0.93028, 0.00000, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.99911, 0.07335, 0.00000, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.90998, 0.00073, 0.00000, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (0.50000, 0.00000, 0.00000, 1.00000)

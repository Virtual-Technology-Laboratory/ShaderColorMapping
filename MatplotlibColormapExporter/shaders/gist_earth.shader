...
Properties {
    ...
    _SegmentData002 ("Segment Color 002", Color) = (0.00261, 0.00000, 0.16869, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.01829, 0.00000, 0.43237, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.02091, 0.00891, 0.45475, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.07318, 0.18931, 0.46911, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.10977, 0.30351, 0.47907, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.13851, 0.38417, 0.48688, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.18817, 0.50193, 0.50039, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.27145, 0.60356, 0.28444, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.28889, 0.60808, 0.27484, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (0.41092, 0.63968, 0.30678, 1.00000)
    _SegmentData012 ("Segment Color 012", Color) = (0.46323, 0.65001, 0.32050, 1.00000)
    _SegmentData013 ("Segment Color 013", Color) = (0.47193, 0.65173, 0.32174, 1.00000)
    _SegmentData014 ("Segment Color 014", Color) = (0.71762, 0.71707, 0.36884, 1.00000)
    _SegmentData015 ("Segment Color 015", Color) = (0.75368, 0.64256, 0.39613, 1.00000)
    _SegmentData016 ("Segment Color 016", Color) = (0.75534, 0.63922, 0.40574, 1.00000)
    _SegmentData017 ("Segment Color 017", Color) = (0.75973, 0.64128, 0.41535, 1.00000)
    _SegmentData018 ("Segment Color 018", Color) = (0.76850, 0.64470, 0.43456, 1.00000)
    _SegmentData019 ("Segment Color 019", Color) = (0.77727, 0.64814, 0.45378, 1.00000)
    _SegmentData020 ("Segment Color 020", Color) = (0.78604, 0.65489, 0.47299, 1.00000)
    _SegmentData021 ("Segment Color 021", Color) = (0.84307, 0.69907, 0.59789, 1.00000)
    _SegmentData022 ("Segment Color 022", Color) = (0.85184, 0.71031, 0.61711, 1.00000)
    _SegmentData023 ("Segment Color 023", Color) = (0.86061, 0.72153, 0.63632, 1.00000)
    _SegmentData024 ("Segment Color 024", Color) = (0.86938, 0.73229, 0.65554, 1.00000)
    _SegmentData025 ("Segment Color 025", Color) = (0.87377, 0.73767, 0.66515, 1.00000)
    _SegmentData026 ("Segment Color 026", Color) = (0.87816, 0.74308, 0.67697, 1.00000)
    _SegmentData027 ("Segment Color 027", Color) = (0.92641, 0.82745, 0.80700, 1.00000)
    _SegmentData028 ("Segment Color 028", Color) = (0.94395, 0.86341, 0.85428, 1.00000)
    _SegmentData029 ("Segment Color 029", Color) = (0.95272, 0.88162, 0.87792, 1.00000)
    _SegmentData030 ("Segment Color 030", Color) = (0.99220, 0.98430, 0.98430, 1.00000)
    _SegmentData031 ("Segment Color 031", Color) = (0.99220, 0.98430, 0.98430, 1.00000)

...
Properties {
    ...
    _SegmentData001 ("Segment Color 001", Color) = (0.43925, 0.00000, 0.50193, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.53069, 0.00000, 0.59738, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.01046, 0.00000, 0.66539, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.00000, 0.00000, 0.86670, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.00000, 0.46931, 0.86670, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.00000, 0.59477, 0.86670, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.00000, 0.66539, 0.67062, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.00000, 0.66670, 0.53330, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.00000, 0.60261, 0.00000, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.00000, 0.73853, 0.00000, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (0.00000, 0.86408, 0.00000, 1.00000)
    _SegmentData012 ("Segment Color 012", Color) = (0.00000, 1.00000, 0.00000, 1.00000)
    _SegmentData013 ("Segment Color 013", Color) = (0.73722, 0.99869, 0.00000, 1.00000)
    _SegmentData014 ("Segment Color 014", Color) = (0.93592, 0.92807, 0.00000, 1.00000)
    _SegmentData015 ("Segment Color 015", Color) = (1.00000, 0.78824, 0.00000, 1.00000)
    _SegmentData016 ("Segment Color 016", Color) = (1.00000, 0.60000, 0.00000, 1.00000)
    _SegmentData017 ("Segment Color 017", Color) = (0.99739, 0.00000, 0.00000, 1.00000)
    _SegmentData018 ("Segment Color 018", Color) = (0.86408, 0.00000, 0.00000, 1.00000)
    _SegmentData019 ("Segment Color 019", Color) = (0.80000, 0.04706, 0.04706, 1.00000)
    _SegmentData020 ("Segment Color 020", Color) = (0.80000, 0.80000, 0.80000, 1.00000)

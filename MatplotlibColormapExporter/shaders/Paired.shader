...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (0.65098, 0.80784, 0.89020, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.12572, 0.47323, 0.70733, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.68900, 0.86817, 0.54376, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.21172, 0.63326, 0.18122, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.98321, 0.59802, 0.59423, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.89060, 0.10450, 0.11108, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.99176, 0.74648, 0.43402, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.99991, 0.50099, 0.00512, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.78330, 0.68724, 0.83368, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.42485, 0.25115, 0.60386, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.99760, 0.99489, 0.59652, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (0.69412, 0.34902, 0.15686, 1.00000)

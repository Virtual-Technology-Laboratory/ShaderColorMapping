...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (0.32941, 0.18824, 0.01961, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.54471, 0.31511, 0.03883, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.74902, 0.50588, 0.17647, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.87205, 0.75579, 0.48404, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.96471, 0.90980, 0.76471, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.95725, 0.95994, 0.95955, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.78039, 0.91765, 0.89804, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.49619, 0.79977, 0.75302, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.20784, 0.59216, 0.56078, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.00384, 0.39677, 0.36509, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.00000, 0.23529, 0.18824, 1.00000)

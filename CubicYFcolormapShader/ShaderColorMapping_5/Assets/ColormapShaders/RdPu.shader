...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (1.00000, 0.96863, 0.95294, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.99214, 0.87802, 0.86622, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.98817, 0.77138, 0.75260, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.98025, 0.62099, 0.70888, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.96703, 0.40464, 0.63076, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.86305, 0.20000, 0.59023, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.67755, 0.00392, 0.49347, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.47316, 0.00381, 0.46527, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.28627, 0.00000, 0.41569, 1.00000)

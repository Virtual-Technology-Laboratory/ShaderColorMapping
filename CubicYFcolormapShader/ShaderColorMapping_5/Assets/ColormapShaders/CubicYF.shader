...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (0.51510, 0.04820, 0.66970, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.51990, 0.17620, 0.80830, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.48840, 0.29120, 0.92340, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.42970, 0.38550, 0.99210, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.38930, 0.47920, 0.97750, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.33370, 0.56500, 0.90560, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.27950, 0.64190, 0.82870, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.22100, 0.71230, 0.72580, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.24680, 0.76120, 0.62480, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.28330, 0.81250, 0.50690, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.31980, 0.84920, 0.39560, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (0.36020, 0.88960, 0.29190, 1.00000)
    _SegmentData012 ("Segment Color 012", Color) = (0.45680, 0.91360, 0.30180, 1.00000)
    _SegmentData013 ("Segment Color 013", Color) = (0.60330, 0.92550, 0.32950, 1.00000)
    _SegmentData014 ("Segment Color 014", Color) = (0.70660, 0.92550, 0.34140, 1.00000)
    _SegmentData015 ("Segment Color 015", Color) = (0.80000, 0.92550, 0.35290, 1.00000)

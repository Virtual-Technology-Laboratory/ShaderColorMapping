...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (0.47060, 0.00000, 0.52160, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.51370, 0.05270, 0.70960, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.49420, 0.25070, 0.87810, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.42960, 0.38580, 0.99220, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.36910, 0.51720, 0.94950, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.29630, 0.61910, 0.85150, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.21990, 0.71340, 0.72250, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.26430, 0.78360, 0.57560, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.30940, 0.83880, 0.42480, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.36230, 0.89170, 0.28580, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.52000, 0.92100, 0.31370, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (0.68000, 0.92550, 0.33860, 1.00000)
    _SegmentData012 ("Segment Color 012", Color) = (0.80000, 0.92550, 0.35290, 1.00000)
    _SegmentData013 ("Segment Color 013", Color) = (0.87060, 0.85490, 0.36080, 1.00000)
    _SegmentData014 ("Segment Color 014", Color) = (0.95140, 0.74660, 0.36860, 1.00000)
    _SegmentData015 ("Segment Color 015", Color) = (0.97650, 0.58870, 0.35690, 1.00000)

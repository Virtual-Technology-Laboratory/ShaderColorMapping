...
Properties {
    ...
    _SegmentData001 ("Segment Color 001", Color) = (0.92506, 0.90554, 0.94884, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.81439, 0.81899, 0.90162, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.64867, 0.74025, 0.85827, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.45109, 0.66121, 0.81084, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.20800, 0.56225, 0.75171, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.01952, 0.43719, 0.68697, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.01547, 0.34928, 0.54724, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.00784, 0.21961, 0.34510, 1.00000)

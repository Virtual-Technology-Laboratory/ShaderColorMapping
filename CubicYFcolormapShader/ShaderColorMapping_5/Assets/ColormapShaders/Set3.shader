...
Properties {
    ...
    _SegmentData000 ("Segment Color 000", Color) = (0.55294, 0.82745, 0.78039, 1.00000)
    _SegmentData001 ("Segment Color 001", Color) = (0.99649, 0.99865, 0.70258, 1.00000)
    _SegmentData002 ("Segment Color 002", Color) = (0.74910, 0.73366, 0.85250, 1.00000)
    _SegmentData003 ("Segment Color 003", Color) = (0.97869, 0.50731, 0.45666, 1.00000)
    _SegmentData004 ("Segment Color 004", Color) = (0.50773, 0.69426, 0.82224, 1.00000)
    _SegmentData005 ("Segment Color 005", Color) = (0.99102, 0.70653, 0.38442, 1.00000)
    _SegmentData006 ("Segment Color 006", Color) = (0.70310, 0.86994, 0.41166, 1.00000)
    _SegmentData007 ("Segment Color 007", Color) = (0.98487, 0.80471, 0.89232, 1.00000)
    _SegmentData008 ("Segment Color 008", Color) = (0.84830, 0.84277, 0.84840, 1.00000)
    _SegmentData009 ("Segment Color 009", Color) = (0.73824, 0.50854, 0.74167, 1.00000)
    _SegmentData010 ("Segment Color 010", Color) = (0.80157, 0.92163, 0.76990, 1.00000)
    _SegmentData011 ("Segment Color 011", Color) = (1.00000, 0.92941, 0.43529, 1.00000)
